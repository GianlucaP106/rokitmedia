                    ...
                    <div>
                        <div className="row">
                            ...
                            <div className="col centerItemV">
                                <h1 className="ourFontBold fontSize40 text-white webdevTitleFont" style={{fontWeight: "bold"}}>Graphic Design</h1>
                            </div>
                        </div>
                        <div className="row" style={{paddingTop: "30px"}}>
                            <div className="col">
                                <p className="ourFontBold fontSize24 text-white">With a range from logos, to banners, promotional images, labels, and more - Rokit Media will professionally design your graphics. </p>
                            </div>
                        </div>
